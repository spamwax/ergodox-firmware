...
KB_MATRIX_LAYER(
	...
	2         , _K    , _M , _comma  , _period , _quote     , _ctrlR    ,
...
KB_MATRIX_LAYER(
	...
	NULL,
	// left hand
	kprrel  , kprrel  , kprrel   , kprrel   , kprrel , kprrel , lpush5 ,
...
KB_MATRIX_LAYER(
	...
	ktrans,	ktrans,	ktrans,	ktrans,	ktrans,	kprrel,	lpush6,
	ktrans,	ktrans,	ktrans,	ktrans,	ktrans,
	ktrans,	ktrans,
	NULL,	NULL,	ktrans,
	ktrans,	ktrans,	ktrans,
...
KB_MATRIX_LAYER(
	...
	ktrans,	ktrans,	ktrans,	kprrel,	ktrans,	kprrel,	ktrans,
	kprpst,	ktrans,	kprrel,	kprrel,	kprrel,	kprrel,
	ktrans,	ktrans,	ktrans,	ktrans,	ktrans,	kprrel,	NULL,
	ktrans,	ktrans,	ktrans,	ktrans,	ktrans,
	ktrans,	ktrans,
	NULL,	NULL,	ktrans,
	ktrans,	ktrans,	ktrans,
